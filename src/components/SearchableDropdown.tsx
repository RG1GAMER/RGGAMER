          ...
          <div className="flex-1 overflow-y-auto p-2 custom-scrollbar">
            {trimmedSearch && !hasExactMatch && (
              <div
                ...
                className="px-3 py-2.5 rounded-lg cursor-pointer flex items-center justify-between text-sm bg-theme-500/10 hover:bg-theme-500/20 text-theme-300 border border-theme-500/30 mb-1 transition-colors"
              >
                <span>Use custom: <strong className="text-foreground">{trimmedSearch}</strong></span>
                <span className="text-[10px] bg-theme-500/20 px-1.5 py-0.5 rounded text-foreground uppercase tracking-wider">Custom</span>
              </div>
            )}
